...
public:
	...
	GuidedBDPTIntegrator(Stream *stream, InstanceManager *manager)
	 : Integrator(stream, manager) {
		m_config = GuidedBDPTConfiguration(stream);
	}
...
MTS_EXPORT_PLUGIN(GuidedBDPTIntegrator, "Guided bidirectional path tracer");
MTS_NAMESPACE_END
