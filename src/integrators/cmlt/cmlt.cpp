...
class CMLT : public Integrator {
public:
	CMLT(const Properties &props) : Integrator(props) {
	...
	CMLT(Stream *stream, InstanceManager *manager)
	...
	bool render(Scene *scene, RenderQueue *queue, const RenderJob *job,
		...
		ref<CMLTSampler> mltSampler = new CMLTSampler(m_config);
...
MTS_IMPLEMENT_CLASS_S(CMLT, false, Integrator)
MTS_EXPORT_PLUGIN(CMLT, "Connection MLT");
MTS_NAMESPACE_END
