...
BASEINCLUDE     = ['#include', '#dependencies/include','#src/']
IMPLIBINCLUDE   = ['#src/LibImportance/wxWidgets-2.9.5/lib/vc_dll/mswu','#src/LibImportance/wxWidgets-2.9.5/include']
WXWIDGETSDIR	= ['#src/LibImportance/wxWidgets-2.9.5/lib/vc_dll/']
WXWIDGETSLIB    = ['wxmsw29u_core.lib','wxbase29u.lib','wxmsw29u_gl.lib','wxpng.lib','wxzlib.lib','comctl32.lib','Rpcrt4.lib']
